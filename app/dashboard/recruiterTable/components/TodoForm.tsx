    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
        ...
        <FormField
          ...
          name="completed"
          render={({ field }) => (
            <FormItem className="flex flex-row mt-auto  gap-2  items-start space-x-3 space-y-0 rounded-md border p-4 shadow">
              <FormControl>
                <Checkbox
                  checked={field.value}
        ...
        />
        <Button type="submit" className="w-11/12 ml-4" variant="outline">
          Submit
        </Button>
      </form>
    </Form>
