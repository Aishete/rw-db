        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="recuiter name" onChange={field.onChange} />
              </FormControl>
              <FormDescription>This is your recuiter name.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="recuiter Code" onChange={field.onChange} />
              </FormControl>
              <FormDescription>This is your recuiter code.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
